...
function MainPage({ onNavigateToHome, onNavigateToMyBets }) {
  ...
  const handleCompetitionClick = (competitionId) => {
    console.log(`Navegando a competición: ${competitionId}`);
    // Aquí puedes agregar la lógica de navegación a cada competición
  };
    ...
    <div className="mainpage-container">
      ...
      <main className="main-content">
        ...
        <section className="quick-access-section">
          <div className="quick-access-card" onClick={onNavigateToMyBets}>

...
import competitionImg from './images/ligue1.png';

function Ligue1Page({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  const COMPETITION_ID = 'liga_fr';
  const COMPETITION_NAME = 'LIGUE 1';
  const COMPETITION_DESCRIPTION = 'Francia • Liga Nacional';

...
function CoppaItaliaPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  const COMPETITION_ID = 'copa_it'; // Asegúrate que coincide con tu backend
      ...
      <main className="main-content">
        <div className="competition-header">
          <div className="competition-logo">
            <img src={coppaItaliaImg} alt="Coppa Italia" />
          </div>
          <div className="competition-title">
            <h1>COPPA ITALIA</h1>
            <span>Italia • Copa Nacional</span>
          </div>
        </div>
...
export default CoppaItaliaPage;

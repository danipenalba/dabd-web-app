...
import competitionImg from './images/coupefrance.png'; // Change this for each competition

function CompetitionPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  // Change these constants for each competition
  const COMPETITION_ID = 'copa_fr'; 
  const COMPETITION_NAME = 'COUPE FRANCE';
  const COMPETITION_DESCRIPTION = 'Francia • Copa Nacional';

...
import competitionImg from './images/superliga.png';

function SuperligaPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  const COMPETITION_ID = 'superliga';
  const COMPETITION_NAME = 'SUPERLIGA';
  const COMPETITION_DESCRIPTION = 'Europa • Copa Internacional';

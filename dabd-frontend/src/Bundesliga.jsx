...
import './LaLigaPage.css'; // Puedes renombrar este archivo si prefieres BundesligaPage.css
import bundesligaImg from './images/bundesliga.png';

function BundesligaPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
      ...
      <main className="main-content">
        <div className="competition-header">
          <div className="competition-logo">
            <img src={bundesligaImg} alt="Bundesliga" />
          </div>
          <div className="competition-title">
            <h1>BUNDESLIGA</h1>
            <span>Alemania • Liga Nacional</span>
          </div>
        </div>

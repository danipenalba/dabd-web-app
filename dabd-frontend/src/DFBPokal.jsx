...
import competitionImg from './images/dfbpokal.jpg';

function DFBPokalPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  const COMPETITION_ID = 'copa_de';
  const COMPETITION_NAME = 'DFB POKAL';
  const COMPETITION_DESCRIPTION = 'Alemania • Copa Nacional';

...
function CopaDelReyPage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
      ...
      <main className="main-content">
        <div className="competition-header">
          <div className="competition-logo">
            <img src={copareyImg} alt="Copa del Rey" />
          </div>
          <div className="competition-title">
            <h1>COPA DEL REY</h1>
            <span>España • Copa Nacional</span>
          </div>
        </div>

...
import competitionImg from './images/premier.png';

function PremierLeaguePage({ onNavigateToHome, onNavigateToMyBets, onNavigateBack }) {
  ...
  const COMPETITION_DESCRIPTION = 'Inglaterra • Liga Nacional';
